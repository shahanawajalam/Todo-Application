  ...
  return (
    <div className={isNight?"":"bg-dark text-white"}>
      <nav className="navbar">
        <span className="navbar-brand mb-0 h1">TODO APPLICATION</span>
        <div className="inline-block">
        
            <i
              class={
                isNight
                  ? "fa fa-toggle-on float-right "
                  : "fa fa-toggle-off float-right"
              }
              onClick={() => setIsNight(!isNight)}
            ></i>
            <h8 className="night float-right">Night Mode</h8>
